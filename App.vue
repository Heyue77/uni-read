...
<style>
	...
	@font-face {
	  font-family: 'iconfont';  /* Project id 2895082 */
	  src: url('//at.alicdn.com/t/font_2895082_djj4pt421jv.woff2?t=1636076950756') format('woff2'),
	...
	.icon-changyong_xiala:before {
	  content: "\e6ae";
	}
	
	.icon-changyong_bofang:before {
	  content: "\e6af";
	}
	
	.icon-changyong_chenggong:before {
	  content: "\e6b0";
	}
	...
	.icon-changyong_shezhi:before {
	  content: "\e6b3";
	}
	
	.icon-changyong_xihuan:before {
	  content: "\e6b5";
	}
	
	.icon-shinei_lvzhi02:before {
	  content: "\e6d0";
	}
	
	.icon-shinei_yangtai02:before {
	  content: "\e6d1";
	}
	
	.icon-shinei_fengshan02:before {
	  content: "\e6d2";
	}
</style>
